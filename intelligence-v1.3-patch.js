...
function decorateHelp(){document.querySelectorAll('.card.help ul').forEach(ul=>{if(ul.querySelector('[data-v13-note]'))return;const li=document.createElement('li');li.dataset.v13Note='1';li.innerHTML='<b>V1.3 情报层</b>：岗位层展示月薪/年薪、来源与可信度；公司层展示带时间、来源和证据等级的历史风险事件。上述情报独立于 S/A/B，不把未经核实传闻当事实。';ul.append(li)})}
